...
export function SiteShell({ children }: { children: ReactNode }) {
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen" style={{ background: "var(--e-bg)", color: "var(--e-text)" }}>
        <Navbar />
        ...
        {/* Mobile sticky bar */}
        <div className="md:hidden fixed inset-x-0 bottom-0 z-50 px-3 py-2.5 flex gap-2"
             style={{ background: "var(--e-navy)", borderTop: "1px solid var(--e-blue-bdr)" }}>
          ...
          <a href="/contact"
             className="flex-1 flex items-center justify-center gap-1.5 rounded-[8px] py-3 text-[12px] font-bold"
